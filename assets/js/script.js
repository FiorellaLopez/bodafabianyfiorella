...
/*------------------------------------------
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024/02/03', function(event) {
    ...
    -------------------------------------------*/
    if ($("#clock2").length) {
        $('#clock2').countdown('2024/02/03', function(event) {
            var $this = $(this).html(event.strftime(''
    ...
    if ($("#contact-form-main").length) {
        $("#contact-form-main").validate({
            ...
            messages: {
                ...
                phone: "Por favor ingresa tu número",
                service: "Por favor ingresa tu alergia si aplica",
                meal: "Por favor ingresa tu preferencia"
            },
